...
from utils import save_config, expand_attention_types_params, yes_or_no, remove_gs_or_filepath, setup_logging, \
    check_dataset
from inputs import sequential_input, pred_input, handle_pred_output, mlm_sample_text, generic_text, synthetic_input
...
def main(args):
    ...
    elif input_fn == "synthetic_input":
        input_fn = synthetic_input
    ...
    try:
        ...
        logger.warning(f"Could not load global step from checkpoint dir {params['model_path']}: {e}")
        current_step = 0
